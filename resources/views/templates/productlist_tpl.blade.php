...
?>
<main class="index">
    <div class="text-white text-uppercase banner" style="background: url({{ asset('public/images/product/1.jpg')  }}) no-repeat center center; background-size: cover;">
        
        <div class="container">
            <div class="banner-wrap">
                <h2 class="s24 pt-2 pb-3 banner-stit">Đi đi - đừng ngần ngại</h2>
                <h1 class="bold s72">{{$product_cate->name}}</h1>
            </div>
        </div>
    </div>
    <!-- slider-area-end -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <article class="pgage-item">
                        ...
                        <div class="text-center ppage-over">
                            <img src="{{ asset('public/images/product/plus.png')}}" title="{{$item->name}}" alt="{{$item->name}}">
