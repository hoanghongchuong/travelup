...
<main class="index">
    ...
    <section class="b2 prolist">
        <div class="container">
            ...
            <h2 class="bold s30 plist-tit"><a href="{{url('san-pham/'.$cate->alias)}}">{{$cate->name}}</a></h2>
            <div class="row gutter-10">
                <?php $products = DB::table('products')->where('cate_id', $cate->id)->orderBy('id','desc')->take(12)->get(); ?>
