      			...
      			<div class="nav-tabs-custom">
	                ...
	                <div class="tab-content">
	                  	<div class="tab-pane active" id="tab_1">
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	<label for="desc">slogan footer</label>
								      	<textarea name="mota" rows="5" class="form-control">{{ old('mota', isset($data) ? $data->mota : null) }}</textarea>
									</div>
									<div class="form-group">
								      	<label for="ten">Slogan phương thức thanh toán</label>
								      	<textarea name="slogan_payment" id="" class="form-control">{{ $data->slogan_payment }}</textarea>
									</div>
									<!-- <div class="form-group">
								...
								<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<input type="text" name="linkedin" value="{!! old('linkedin', isset($data) ? $data->linkedin : null) !!}"  class="form-control" />
									</div>
									<div class="form-group">
										<label for="ten">Skype</label>
								      	<input type="text" name="skype" value="{!! old('skype', isset($data) ? $data->skype : null) !!}"  class="form-control" />
									</div>
									<div class="form-group">
	                	...
	                	<div class="tab-pane" id="tab_4">
							...
							<div class="form-group">
								<div class="form-group">
									<img src="{{ asset('upload/hinhanh/'.$data->photo2) }}" onerror="this.src='{{asset('public/admin_assets/images/no-image.jpg')}}'" width="200"  alt="NO PHOTO" />
								</div>
								<label for="file">Chọn file logo2</label>
