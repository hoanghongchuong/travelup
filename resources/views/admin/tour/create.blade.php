        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box ">
                    ...
                    <!-- form start -->
                    <form name="frmAdd" method="post" action="{{  route('admin.tour.create') }}" enctype="multipart/form-data">
                        {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="form-group @if ($errors->first('alias')!='') has-error @endif">
                                                ...
                                                <input type="text" name="alias" id="txtAlias" value=""  class="form-control" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phuongtien"  value=""  class="form-control" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input name="title" rows="5" class="form-control">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="active" checked="checked"> Hiển thị
                                </label>
                            </div>
