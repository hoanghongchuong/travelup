    ...
    <div class="col-xs-12">
      <div class="box">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/members/edit/{{$item->id}}">Edit</a>
                </td>
                <td class="text-center">
                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/members/delete/{{$item->id}}">Delete</a>
                </td>
              </tr>
              @endforeach
            </tbody>
        ...
        <div class="box-footer col-md-12">
          <div class="col-md-6">
            <input type="button" onclick="javascript:window.location='backend/members/add'" value="Thêm" class="btn btn-primary" />
